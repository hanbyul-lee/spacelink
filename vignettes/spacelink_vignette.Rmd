---
title: "Spacelink Global SVG Vignette"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Spacelink Global SVG Vignette}
...
Here, we demonstrate the spatial gene variability analysis at the *global tissue level* using the [`spacelink`](https://hanbyul-lee.github.io/spacelink/reference/spacelink.html) function through a simple simulation example.

...
![](../man/figures/CNP.pdf){#id .class width=50% height=50%}

![](../man/figures/SHISA5.pdf){#id .class width=50% height=50%}
...
![](../man/figures/oligodendrocyte.pdf){#id .class width=50% height=50%}

![](../man/figures/KRT19.pdf){#id .class width=50% height=50%}

![](../man/figures/HOPX.pdf){#id .class width=50% height=50%}
---
title: "Visium Human DLPFC Analysis"
...
Cell-type proportions were estimated using [RCTD](https://github.com/dmcable/spacexr) with the [CosMx Human Frontal Cortex dataset](https://brukerspatialbiology.com/products/cosmx-spatial-molecular-imager/ffpe-dataset/human-frontal-cortex-ffpe-dataset/) as a reference. 
...
which tests for spatial variability across all spots regardless of cell type, 
and (2) **cell-type-specific** SVG detection, 
which tests for spatial variability within a specific cell population.

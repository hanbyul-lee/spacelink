...
Here, we demonstrate the workflow for spatial gene variability analysis at the *cell-type–specific level* using the [`spacelink_ctSVG`](https://hanbyul-lee.github.io/spacelink/reference/spacelink_ctSVG.html) function through a simple simulation example.

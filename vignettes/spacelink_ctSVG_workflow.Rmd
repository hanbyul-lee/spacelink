...
Since [`spacelink_ctSVG`](https://hanbyul-lee.github.io/spacelink/reference/spacelink_ctSVG.html) requires normalized input data, we first normalize the count data (`expr_data`) before running the method.
...
We now run [`spacelink_ctSVG`](https://hanbyul-lee.github.io/spacelink/reference/spacelink_ctSVG.html) using the normalized data (`norm_data`), the spatial coordinates (`coords`), and the cell type proportions (`cell_type_props`).

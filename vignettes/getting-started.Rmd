...
If you have cell type proportion data, analyze cell-type-specific spatial patterns:
...
**ESV Scores**:
- ESV (between 0 and 1): Spatial pattern is stronger as ESV is closer to 1.

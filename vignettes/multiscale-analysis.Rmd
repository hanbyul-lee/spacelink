...
```{r eval=FALSE}
## [1] "endothelial"  "L2_3"  "L4"  "L6"  "oligodendrocyte"  "OPC"  "astro"  "Inh"  "microglia"
```

```{r eval=FALSE}
cell_type_spacelink_results <- spacelink_cell_type(normalized_counts = counts[1:5,], spatial_coords = spatial_coords, cell_type_proportions = cell_type_proportions, focal_cell_type = "oligodendrocyte",
  global_spacelink_results = global_results, # This is not required, though providing global results can slightly improve efficiency.
  calculate_ESV = TRUE)
```
